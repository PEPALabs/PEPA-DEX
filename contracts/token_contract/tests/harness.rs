...
// use fuels::{prelude,prelude::*, tx::{AssetId,ContractId}};
// use rand::{Fill,*};
...
//     .await
//     .unwrap();
//     let token_instance = Token::new(token_contract_id.to_string(), wallet_owner.clone()).build();
...
//     let token_mint1_instance = Token::new(token_contract_id.to_string(), wallet_mint1.clone()).build();
...
//     let token_mint2_instance = Token::new(token_contract_id.to_string(), wallet_mint2.clone()).build();
